...
Когда нужно УДАЛИТЬ процесс, отвечай строго JSON:
	{
	  "reply": "Запрашиваю подтверждение на удаление процесса.",
	  "delete_workflow": {
	    "id": "id-процесса-для-удаления"
	  }
	}

	Когда нужно УДАЛИТЬ НЕСКОЛЬКО процессов, отвечай строго JSON:
	{
	  "reply": "Запрашиваю подтверждение на пакетное удаление.",
	  "delete_workflows": {
	    "ids": ["id-1", "id-2"]
	  }
	}
