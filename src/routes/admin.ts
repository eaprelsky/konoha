...
export const SYSTEM_AGENTS: SeededSystemAgent[] = [
  ...
  },
  {
    ...
    tags: ["system", "connector-owned", "autostart"],
    capabilities: ["konoha-lite", "telethon", "telegram-monitor", "telegram-escalator", "telegram-responder", "telegram-router"],
  ...
  },
  {
    ...
    capabilities: ["deprecated-compat"],
  ...
  },
  {
    ...
    capabilities: ["konoha-lite", "architecture", "process-analysis", "workflow-decomposition", "issue-decomposition", "strategy", "code-review"],
    tool_profile: "default",
    sandbox_profile: "tmux",
