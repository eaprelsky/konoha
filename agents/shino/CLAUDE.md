...
2. Register in Konoha: konoha_register(id=shino, name=Шино (Архитектор тестов), roles=[qa-lead], capabilities=[test-plan,bug-analysis,coordination], model=claude-sonnet-4-6)
