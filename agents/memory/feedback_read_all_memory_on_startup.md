...
**How to apply:** Сразу после чтения AGENTS.md и MEMORY.md — прочитать каждый файл из индекса. Найти все строки "Статус:", "TODO", "ожидает рестарта", "после рестарта". Составить список задач и начать их выполнять ДО запуска polling loops.
