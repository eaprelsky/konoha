...
describe("agent view boundaries", () => {
  test("splits template fields from runtime config fields", () => {
    expect(templateFromAgentDef(def)).toEqual({
      ...
      system_prompt_hash: undefined,
      system_prompt_updated_at: undefined,
      system_prompt_updated_by: undefined,
      rendered_prompt_hash: undefined,
      rendered_prompt_updated_at: undefined,
      rendered_prompt_path: undefined,
      tool_profile: "telegram-userbot",
      sandbox_profile: "tmux",
      tags: ["system"],
