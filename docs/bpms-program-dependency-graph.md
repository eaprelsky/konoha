...
| M1 Environment isolation | Make staging/test safe before workflow engine behavior changes. | #682, #733-#736, #749 | M0 | Tests cannot write prod Redis/PG; staging smoke runs without prod connectors/fleet; rollback/preflight ownership exists. |
...
| M5 Runtime correctness and operations | Stabilize transition planning, observability, recovery, audit, retention, production preflight evidence, and PG_READ readiness. | #680, #681, #683, #725-#740, #750, #751 | M4 | Pure transition planner exists; effect boundary is explicit; monitor/recovery/audit views work; PG_READ is entity-scoped and gated. |
| M6 Acceptance and extraction | Prove constructor -> deploy -> run -> assigned work item before package extraction and production signoff. | #684-#686, #741-#748 | M5 | Golden-path and negative suites pass; #686 final release gate is satisfied; #618 extraction checklist is updated and remains blocked until semantics are stable. |
...
#776 -> #757 -> #760/#761 -> #780/#781/#777/#778/#785
  ...
  -> #677/#678/#679 -> #680/#681/#720/#750/#751/#754/#683
  -> #685 -> #684/#686 -> #618
```
...
| #681 observability and recovery | #678, #680 | #729-#732, #750 |
...
| --- | --- | --- | --- |
| Runtime diet | immediately, one issue at a time under current delivery policy | M1 | #760, #761, #762, #763, #768, #774, #777, #778, #780, #781, #785, #790, #791, #792, #794 |
| Test isolation | M0 budget/profile gates | M2 | #682, #733-#736, #749 |
...
| Operations/persistence | M4 | M6 | #680, #681, #683, #725-#740, #750, #751, #754, #787-#789 |
| Acceptance/extraction | M5 | release | #684-#686, #741-#748, #618 |
...
- `follow_up_issues` participate in the same milestone ordering contract as
  #672-#751 issues; an issue must not depend on a later milestone.
