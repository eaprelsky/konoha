...
curl -sS -X POST "$KONOHA_URL/act" -H "Authorization: Bearer $KONOHA_TOKEN" -H "Content-Type: application/json" -d '{"action":"workflow.validate","category":"act","args":{"id":"<workflow_id>"}}'
