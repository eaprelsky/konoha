...
DEFAULT_MODEL_CAPABILITIES: dict[str, set[str]] = {
    ...
    "qwen/qwen3.5-flash": {CAP_TEXT, CAP_VISION, CAP_CHEAP_CLASSIFIER, CAP_REASONING, CAP_LONG_CONTEXT},
    "qwen/qwen3.5-plus": {CAP_TEXT, CAP_VISION, CAP_REASONING, CAP_LONG_CONTEXT},
    "qwen/qwen3.5-27b": {CAP_TEXT, CAP_VISION, CAP_REASONING, CAP_LONG_CONTEXT},
    "qwen/qwen2.5-vl-72b-instruct": {CAP_TEXT, CAP_VISION, CAP_REASONING, CAP_LONG_CONTEXT},
    "qwen/qwen2.5-vl-32b-instruct": {CAP_TEXT, CAP_VISION, CAP_REASONING, CAP_LONG_CONTEXT},
    "qwen/qwen3-vl-32b-instruct": {CAP_TEXT, CAP_VISION, CAP_REASONING, CAP_LONG_CONTEXT},
}
