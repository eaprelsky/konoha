...
while true; do
    ...
    tmux -L "$SESSION" send-keys -t "$SESSION" "CLAUDE_MODEL=claude-haiku-4-5-20251001 claude --dangerously-skip-permissions --mcp-config $MCP_CONFIG" Enter
    sleep 20
